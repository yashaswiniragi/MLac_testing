...
model_name = 'LGBMRegressor_MLBased'
...
IOFiles = {
    ...
    "log": "LGBMRegressor_MLBased_aion.log",
    "model": "LGBMRegressor_MLBased_model.pkl",
    "performance": "LGBMRegressor_MLBased_performance.json",
    "metaDataOutput": "LGBMRegressor_MLBased_modelMetaData.json"
}
...
def train(log):        
    ...
    #Training model
    log.info('Training LGBMRegressor for modelBased')
    features = selected_features['modelBased']            
    estimator = LGBMRegressor()            
    param = config['algorithms']['LGBMRegressor']
