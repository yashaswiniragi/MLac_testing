...
model_name = 'LinearRegression_MLBased'
...
IOFiles = {
    ...
    "log": "LinearRegression_MLBased_aion.log",
    "model": "LinearRegression_MLBased_model.pkl",
    "performance": "LinearRegression_MLBased_performance.json",
    "metaDataOutput": "LinearRegression_MLBased_modelMetaData.json"
}
...
def train(log):        
    ...
    #Training model
    log.info('Training LinearRegression for modelBased')
    features = selected_features['modelBased']            
    estimator = LinearRegression()            
    param = config['algorithms']['LinearRegression']
