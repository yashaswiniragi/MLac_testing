...
model_name = 'RandomForestRegressor_MLBased'
...
IOFiles = {
    ...
    "log": "RandomForestRegressor_MLBased_aion.log",
    "model": "RandomForestRegressor_MLBased_model.pkl",
    "performance": "RandomForestRegressor_MLBased_performance.json",
    "metaDataOutput": "RandomForestRegressor_MLBased_modelMetaData.json"
}
...
def train(log):        
    ...
    #Training model
    log.info('Training RandomForestRegressor for modelBased')
    features = selected_features['modelBased']            
    estimator = RandomForestRegressor()            
    param = config['algorithms']['RandomForestRegressor']
