...
model_name = 'CatBoostRegressor_MLBased'
...
IOFiles = {
    ...
    "log": "CatBoostRegressor_MLBased_aion.log",
    "model": "CatBoostRegressor_MLBased_model.pkl",
    "performance": "CatBoostRegressor_MLBased_performance.json",
    "metaDataOutput": "CatBoostRegressor_MLBased_modelMetaData.json"
}
...
def train(log):        
    ...
    #Training model
    log.info('Training CatBoostRegressor for modelBased')
    features = selected_features['modelBased']            
    estimator = CatBoostRegressor()            
    param = config['algorithms']['CatBoostRegressor']
