...
IOFiles = {
    ...
    "log": "Lasso_MLBased_aion.log",
    "model": "Lasso_MLBased_model.pkl",
    "performance": "Lasso_MLBased_performance.json",
    "metaDataOutput": "Lasso_MLBased_modelMetaData.json"
}
...
def train(log):        
    ...
    #Training model
    log.info('Training Lasso for modelBased')
    features = selected_features['modelBased']            
    estimator = Lasso()            
    param = config['algorithms']['Lasso']
